...
Write-Host "  bash deploy-vps.sh               # [1/3] load imagenes propias"
Write-Host "                                   # [2/3] precarga imagenes de terceros (Grafana + CrowdSec)"
Write-Host "                                   # [3/3] docker compose up -d (base: console, proxy, db,"
Write-Host "                                   #        Alloy, Loki, Prometheus, nginx-exporter)"
