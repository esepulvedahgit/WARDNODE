...
echo ""
echo "En el VPS:"
echo "  cp .env.prod.example .env.prod   # editar secretos reales:"
echo "                                   #   SECRET_KEY, WARDNODE_SECRET_KEY"
echo "                                   #   POSTGRES_PASSWORD, DATABASE_URL"
echo "                                   #   GRAFANA_ADMIN_PASSWORD"
echo "                                   #   GRAFANA_DB_USER=grafana_ro"
echo "                                   #   GRAFANA_DB_PASSWORD=<secreto>"
echo "  bash deploy-vps.sh               # valida variables, [1/3] load imágenes,"
echo "                                   # [2/3] precarga imágenes de terceros,"
echo "                                   # [3/3] docker compose up -d"
echo "                                   # El console crea el rol grafana_ro en arranque."
echo "  # Grafana se activa desde el panel de módulos (OBS)."
