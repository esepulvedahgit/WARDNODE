...
echo ""
echo -e "${BOLD}${GREEN}PASO 3 — Configurar TLS${RESET}"
echo ""
echo "  Para añadir TLS a la consola, sigue las instrucciones que aparecen"
echo "  al primer inicio de sesión en la interfaz web."
echo ""
